<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown">
        ...
        <!--div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/forgot-password.html">Forgot Password</a>
    ...
    <!--li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/categories.html">Movie</a>
    ...
    <li class="nav-item channel-sidebar-list">
        ...
        <ul>
            <li>
                <a href="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/subscriptions.html">
                    <img class="img-fluid" alt="" src="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/img/s1.png"> Your Life 
                </a>
            </li>
            <li>
                <a href="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/subscriptions.html">
                    <img class="img-fluid" alt="" src="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/img/s2.png"> Unboxing  <span class="badge badge-warning">2</span>
                </a>
            </li>
            <li>
                <a href="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/subscriptions.html">
                    <img class="img-fluid" alt="" src="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/img/s3.png"> Product / Service  
                </a>
            </li>
            <li>
                <a href="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/subscriptions.html">
                    <img class="img-fluid" alt="" src="https://askbootstrap.com/preview/vidoe-v2-1/theme-three/img/s4.png">  Gaming 
                </a>
            </li>
        </ul>
    </li>
